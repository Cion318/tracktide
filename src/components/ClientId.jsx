      ...
      <div className="flex flex-col sm:w-2/3 md:w-2/3 lg:w-1/2">
        ...
        <div className="h-2/3 rounded-t-lg bg-zinc-800 bg-opacity-70 p-4">
          ...
          <p className="py-4 text-left text-sm text-gray-100">
            ...
            https://cion318.github.io/jammming/ to the Redirect URIs field
            inside of your app found in your dashboard.
          </p>
        </div>

        {/* Bottom Section (1/3) */}
        <div className="h-1/3 rounded-b-lg bg-green-700 bg-opacity-70 p-4">
          <form onSubmit={check}>
            <div className="">
              <div className="flex">
                <input
                ...
                />
                <button
                  className="focus:shadow-outline ml-1 rounded bg-green-500 px-4 py-2 font-bold text-gray-100 hover:bg-zinc-800 focus:outline-none"
                  type="submit"
                >
